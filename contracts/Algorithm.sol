...
contract Algorithm {
  ...
  struct RP1Table {address userAddress;uint16 RP1;}

  struct RP2Table {address userAddress; uint16 RP2;}
  ...
  constructor() public {
    ...
    userMapping[1].userAddress = 0xc9472850C2bbEBC689b581b92A2E1A694235c9e5;
    userMapping[1].purchasedTokenAmount = 100;
  ...
  function roulette(uint256 hitNumber, uint256 totalIssuance) internal view returns (uint8 winner){
    ...
    for (k = 0; k < 10; k++) {
      ...
      //連想配列を用いる場合
      uint256 _percentage = (userMapping[k].purchasedTokenAmount / totalIssuance) * 100;
